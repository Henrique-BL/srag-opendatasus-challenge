...
queries = [
    "Evolução da Influenza A Brasil",
...
class TavilySearchTool(BaseTool):
    ...
    def _run(
        ...
        try:
            sources = [
                ...
                "https://agenciabrasil.ebc.com.brhttps://www.cnnbrasil.com.br",
    ...
    async def _arun(
        ...
        print(
            f"Searching for {start_date} to {end_date} with {search_depth} depth and {max_results} results"
        )
        try:
            sources = [
                "https://agencia.fiocruz.br",
